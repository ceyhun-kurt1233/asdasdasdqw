...
exports.run = async (client, message) => {
  ...
  const db = require('quick.db');
    ...
    if(secenekler.length < 1) return message.reply(`**vp!küfür-engelle aç** veya **vp!küfür-engelle kapat** yazınz `);
    //if(secenekler === "aç" || "kapat") return message.channel.send(errembed);

  if (secenekler !== "aç" && secenekler !== "kapat" && secenekler !== "on" && secenekler !== "off") return message.reply(`**vp!küfür-engelle aç** veya **vp!küfür-engelle kapat** yazınz `)
    ...
    .setColor('RED')
    .setDescription(`Küfür Engeli Başarıyla açıldı\nKüfür engelini kapatmak isterseniz **vp!küfür-engel kapat** yazmanız yeterlidir.`)
