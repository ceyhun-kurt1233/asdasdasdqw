...
exports.run = async (client, message, args) => {
    const ayarlar = require('../ayarlar.json')
        ...
        if (!message.member.permissions.has("MANAGE_ROLES")) return message.channel.send(new wenzy.MessageEmbed().setDescription('**Bu komudu kullanmak için **Rolleri Yönet** yetkisine sahip olmalısın.**').setColor(10038562));
